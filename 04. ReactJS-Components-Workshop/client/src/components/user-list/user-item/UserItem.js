import { UserActions } from '../user-list-constants/UserListConstants'


export const UserItem = ({ user,  onActionClickHandler }) => {
    return (
        ...
        <>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onActionClickHandler(user._id, UserActions.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onActionClickHandler(user._id, UserActions.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onActionClickHandler(user._id, UserActions.Details)}>
